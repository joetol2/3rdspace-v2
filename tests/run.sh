...
step "Apps Script: how wide a booking is, and what it collides with"
...
for t in calendar-nav calendar-failure venue-time staff-approve docs nav diagram workflow; do
  step "Browser: $t"
